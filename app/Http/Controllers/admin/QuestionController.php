...
class QuestionController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        try {
            $temp = $question->image;
            $page_temp = $question->page;
            $question_bank_id = $question->question_bank_id;
            $question->delete();

            if (!Question::where('question_bank_id', $question_bank_id)->where('page', $page_temp)->exists()) {
                Question::where('page', '>', $page_temp)->where('question_bank_id', $question_bank_id)->decrement('page');
            }
        ...
        return redirect()->route('admin.bank_soal.detail', ['id' => $question->question_bank_id, 'page' => $question->page]);
    }
}
