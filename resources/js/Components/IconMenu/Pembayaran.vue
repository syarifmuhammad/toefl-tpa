<template>
    <svg width="49px" height="49px" fill="#ffffff" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 401.601 401.6" xml:space="preserve" stroke="#ffffff">
