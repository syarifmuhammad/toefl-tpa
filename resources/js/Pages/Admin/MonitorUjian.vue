...
const mulaiUjian = () => {
    const form = useForm({})
    form.patch(route('admin.mulai_ujian', schedule.id))
}
                ...
                <div class="flex justify-between mt-8">
                    <div class="flex gap-x-6 items-center">
                        <div @click="mulaiUjian"
                            class="rounded-full border border-black w-[150px] aspect-square flex items-center justify-center cursor-pointer">
                            <span v-if="schedule.status == 1" class="text-merah-primary text-lg">01:29:44</span>
                ...
                <div class="mt-8">
                    ...
                    <table class="w-full border-b-2 border-abu-component text-medium mt-2">
                        ...
                        <tbody class="text-center">
                            <!-- <tr v-if="registrars.data.length > 0" v-for="(registrar, n) in registrars.data"
